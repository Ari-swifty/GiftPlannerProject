package com.arigarasuthan.giftplannerapp.utils
...
class ProgressBarr(val context: Context) {
    private var dialog: ProgressDialogg
    ...
    class ProgressDialogg(context: Context) : Dialog(context) {
        init {
